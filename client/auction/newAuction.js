...
function NewAuction() {
  ...
  const clickSubmit = () => {
    if (values.bidEnd < values.bidStart) {
      ...
      values.itemName
        && auctionData.append('itemName', values.itemName);
      values.description
        && auctionData.append(
          'description',
          values.description,
      ...
      values.image
        && auctionData.append('image', values.image);
      values.startingBid
        && auctionData.append(
          'startingBid',
          values.startingBid,
      ...
      values.bidStart
        && auctionData.append('bidStart', values.bidStart);
      values.bidEnd
        && auctionData.append('bidEnd', values.bidEnd);
      create(
        {
          userId: jwt.user._id,
        },
